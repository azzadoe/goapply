...
require_once get_template_directory() . '/inc/myarcade_api.php';
// Include setup theme.
...
function myarcadetheme_scripts() {
  ...
  if ( $script_debug ) {
		wp_enqueue_script( 'myarcadetheme-chkbox', get_template_directory_uri() . '/js/' . $subfolder . 'chkbox.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
		wp_enqueue_script( 'myarcadetheme-slctbx', get_template_directory_uri() . '/js/' . $subfolder . 'slctbx.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
		wp_enqueue_script( 'myarcadetheme-botmod', get_template_directory_uri() . '/js/' . $subfolder . 'botmod.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
		wp_enqueue_script( 'myarcadetheme-menu', get_template_directory_uri() . '/js/' . $subfolder . 'menu.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
		wp_enqueue_script( 'myarcadetheme-ajax', get_template_directory_uri() . '/js/' . $subfolder . 'ajax.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
    $localize_script = 'ajax';
	} else {
		// Include general theme JS.
		// This JS file combines chkbox.js, slctbx.js, botmod.js, menu.js, ajax.js.
		wp_enqueue_script( 'myarcadetheme-general', get_template_directory_uri() . '/js/general.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
  ...
  if ( myarcadetheme_get_option( 'slider_home' )
     ...
     || is_active_widget( false, false, 'mabp_most_popular' )
		...
		wp_enqueue_script( 'myarcadetheme-bxslider', get_template_directory_uri() . '/js/bxsldr.min.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
    wp_script_add_data( 'myarcadetheme-bxslider', 'async', true );
  }

  if ( myarcadetheme_get_option( 'lazy_load', 1 ) ) {
		wp_enqueue_script( 'myarcadetheme-lazy-load', get_template_directory_uri() . '/js/echo.min.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
    wp_script_add_data( 'myarcadetheme-lazy-load', 'async', true );
  }

  if ( myarcadetheme_get_option( 'sticky_sidebar', 1 ) && ! wp_is_mobile() ) {
		wp_enqueue_script( 'myarcadetheme-sticky-sidebar', get_template_directory_uri() . '/js/sticky-sidebar.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
    wp_script_add_data( 'myarcadetheme-sticky-sidebar', 'async', true );
  }

  if ( myarcadetheme_get_option( 'smooth_scroll', 1 ) && ! wp_is_mobile() ) {
		wp_enqueue_script( 'myarcadetheme-nice-scroll', get_template_directory_uri() . '/js/lib/jquery.nicescroll.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
    ...
    if ( function_exists('wpfp_link') ) {
      $myvars = array(
        'txt_remove' => wpfp_get_option('remove_favorite'),
			...
			wp_enqueue_script( 'myarcadetheme-favorite', get_template_directory_uri() . '/js/fav.js', array( 'jquery' ), '1.0.0', array( 'in_footer' => true ) );
