...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'Install Required Plugins', 'myarcadetheme' ),
				'menu_title'                      => __( 'Install Plugins', 'myarcadetheme' ),
				/* translators: %s: plugin name. */
				'installing'                      => __( 'Installing Plugin: %s', 'myarcadetheme' ),
				/* translators: %s: plugin name. */
				'updating'                        => __( 'Updating Plugin: %s', 'myarcadetheme' ),
				'oops'                            => __( 'Something went wrong with the plugin API.', 'myarcadetheme' ),
