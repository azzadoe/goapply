      ...
      <footer class="ftcn"  itemscope="itemscope" itemtype="http://schema.org/WPFooter">
        ...
        <div class="ftcn-2">
         <div class="cont" itemprop="text">
          <p>
            <?php
              echo sprintf( __('Proudly powered by %sMyArcadePlugin - WordPress Arcade%s', 'myarcadetheme'), '<a target="_blank" href="https://myarcadeplugin.com/" title="WordPress Arcade" rel="noopener" itemprop="url">', '</a>' ) ;
            ?>
          </p>
        </div>
      </div>
